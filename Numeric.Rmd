...
# 3. Younger individuals tend to have higher misinformation beliefs. Those who rely more on Facebook also tend to have higher misinformation beliefs. Both correlations are statistically significant, but their effects are moderate.
# 4. Men (M = 0.73, SD = 1.13) had more misinformation beliefs than women (M = 0.61, SD = 1.05) in this sample. However, this difference was not statistically significant.
# 5. Reliance on Facebook for coronavirus information significantly predicts higher misinformation beliefs (β = 0.63, p < 0.001). However, the interaction between age and Facebook reliance is negative and significant (β = -0.0096, p = 0.005), meaning that the effect of Facebook reliance on misinformation beliefs weakens as age increases. Younger individuals who rely heavily on Facebook have the highest misinformation beliefs, while older individuals show minimal differences across reliance levels. 
...
# GENDER AND MISINFORMATION BELIEFS
...
# AGE AND MISINFORMATION BELIEFS
...
# LINEAR REGRESSION - FINDING MISINFORMATION BELIEF'S ASSOCIATION WITH AGE & FACEBOOK RELIANCE
